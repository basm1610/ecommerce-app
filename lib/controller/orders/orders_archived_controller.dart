...
import 'package:ecommerce_app/data/datasource/remote/orders/archived.dart';
...
class OrdersArchivedController extends GetxController {
  ...
  getOrders() async {
    ...
    var response = await ordersArchivedData.getData(myServices.sharedPreferences.getString("id")!);
